...
IR_files = sorted(get_img_file(r"/home/cuixinyu/TEDFuse/MSRS_train/train/ir"))
VIS_files  = sorted(get_img_file(r"/home/cuixinyu/TEDFuse/MSRS_train/train/vi"))
LABELS_files  = sorted(get_img_file(r"/home/cuixinyu/TEDFuse/datasets/MSRS/Segmentation_labels"))
...
for i in tqdm(range(len(IR_files))):
        ...
        for ii in range(I_IR_Patch_Group.shape[-1]):
            ...
            if not (bad_IR or bad_VIS ):
                ...
                # print(f"vis shape: {avl_VIS.shape}, ir shape: {avl_IR.shape}, label shape: {avl_LABELS.shape}")
