...
class Fusion_dataset(Dataset):
    def __init__(self, ir_path=None, vi_path=None):
        super(Fusion_dataset, self).__init__()
        # assert split in ['train', 'val', 'test'], 'split must be "train"|"val"|"test"'

        # if split == 'train':
        data_dir_vis = '/home/cuixinyu/MMIF-CDDFuse/MSRS_train/train/vi'
        data_dir_ir = '/home/cuixinyu/MMIF-CDDFuse/MSRS_train/train/ir'
        data_dir_label = '/home/cuixinyu/SeAFusion/datasets/MSRS/Label'
